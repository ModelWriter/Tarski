 ...
 * </p>
 * <ul>
 *   <li>{@link eu.modelwriter.traceability.core.persistence.impl.ItemTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link eu.modelwriter.traceability.core.persistence.impl.ItemTypeImpl#getEntry <em>Entry</em>}</li>
 *   <li>{@link eu.modelwriter.traceability.core.persistence.impl.ItemTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ItemTypeImpl extends MinimalEObjectImpl.Container implements ItemType {
  ...
  protected EClass eStaticClass() {
    return persistencePackage.Literals.ITEM_TYPE;
  }
  ...
  public FeatureMap getGroup() {
    if (group == null) {
      group = new BasicFeatureMap(this, persistencePackage.ITEM_TYPE__GROUP);
    }
    return group;
  }
  ...
  public EList<EntryType> getEntry() {
    return getGroup().list(persistencePackage.Literals.ITEM_TYPE__ENTRY);
  }
  ...
  public void setId(String newId) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, persistencePackage.ITEM_TYPE__ID, oldId, id));
  }
