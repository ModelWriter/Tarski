...
public class persistencePackageImpl extends EPackageImpl implements persistencePackage {
   ...
   * @generated
   */
  public EAttribute getTupleType_Reasoned() {
  ...
  public void createPackageContents() {
    ...
    createEAttribute(tupleTypeEClass, TUPLE_TYPE__REASONED);
  ...
  public void initializePackageContents() {
    ...
    initEAttribute(getTupleType_Reasoned(), ecorePackage.getEBoolean(), "reasoned", null, 0, 1, TupleType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
