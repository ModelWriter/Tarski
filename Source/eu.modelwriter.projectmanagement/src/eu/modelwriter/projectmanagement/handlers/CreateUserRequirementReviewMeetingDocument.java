...
import eu.modelwriter.projectmanagement.github.requirements.FetchUserRequirementReviewMeeting;
import eu.modelwriter.projectmanagement.github.requirements.UserRequirementReviewMeetingDocument;
 ...
 */
public class CreateUserRequirementReviewMeetingDocument extends AbstractHandler {
  /**
   * The constructor.
   */
  public CreateUserRequirementReviewMeetingDocument() {}
  ...
  public Object execute(ExecutionEvent event) throws ExecutionException {
    ...
    if (dialog.open() == Window.OK) {
      ...
      try {
        pmd.run(true, true, FetchUserRequirementReviewMeeting.getInstance());
      ...
      try {
        pmd.run(true, true, new UserRequirementReviewMeetingDocument(selectedIssues));
      } catch (InvocationTargetException e) {
        e.printStackTrace();
        MessageDialogError(window);
      } catch (InterruptedException e) {
