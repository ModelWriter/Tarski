...
import eu.modelwriter.projectmanagement.github.requirements.FetchSoftwareRequirementReviewMeeting;
import eu.modelwriter.projectmanagement.github.requirements.SoftwareRequirementReviewMeetingDocument;

public class CreateSoftwareRequirementReviewMeetingDocument extends AbstractHandler {
  ...
  public Object execute(ExecutionEvent event) throws ExecutionException {
    ...
    if (dialog.open() == Window.OK) {
      ...
      try {
        pmd.run(true, true, FetchSoftwareRequirementReviewMeeting.getInstance());
      ...
      try {
        pmd.run(true, true, new SoftwareRequirementReviewMeetingDocument(selectedIssues));
      } catch (InvocationTargetException e) {
        e.printStackTrace();
        MessageDialogError(window);
      } catch (InterruptedException e) {
