...
public class FetchSoftwareRequirements implements IRunnableWithProgress {

	private static FetchSoftwareRequirements instance = null;
	...
	public static FetchSoftwareRequirements getInstance() {
		if (instance == null) {
			instance = new FetchSoftwareRequirements();
		}
		return instance;
	}
