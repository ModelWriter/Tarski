...
public class FetchSoftwareRequirementReviewMeeting implements IRunnableWithProgress {

  private static FetchSoftwareRequirementReviewMeeting instance = null;
  ...
  public static FetchSoftwareRequirementReviewMeeting getInstance() {
    if (instance == null) {
      instance = new FetchSoftwareRequirementReviewMeeting();
    }
    return instance;
  }
