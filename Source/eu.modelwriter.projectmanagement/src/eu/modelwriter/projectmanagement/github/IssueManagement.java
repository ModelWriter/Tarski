...
public class IssueManagement {
  ...
  public static void updateDeliverables(GitHubClient client, RepositoryId repositoryId) {
    try {
      URL url = new URL(
          "platform:/plugin/eu.modelwriter.projectmanagement/docs/Deliverables - Changes.md");
      ...
      while ((line = bufferedReader.readLine()) != null) {
        ...
        System.out.println(strings[1].trim() + " -> " + strings[3].trim() + " -Month: "
            + strings[2].trim() + " -Type:  " + strings[4].trim() + " -Access:" + strings[5].trim()
        ...
        int milestone =
            Integer.parseInt(strings[2].trim().substring(2, strings[2].indexOf(']') - 1));
        String body = "";
        String assignee = "";
        String type = "";
  ...
  public static void updateTasks(GitHubClient client, RepositoryId repositoryId) {
    try {
      URL url = new URL(
          "platform:/plugin/eu.modelwriter.projectmanagement/docs/Tasks - Changes - WP7.md");
      BufferedReader bufferedReader =
          new BufferedReader(new InputStreamReader(url.openStream(), "UTF-8"));
      String line;
      bufferedReader.readLine();
  ...
  private static void changeLabelNameByTaskCode(GitHubClient client, RepositoryId repositoryId,
      String taskCode, String changedName) throws IOException {
  ...
  private static Issue getIssueStartsWith(GitHubClient client, RepositoryId repositoryId,
      String startsWith) throws IOException {
    IssueService iService = new IssueService(client);
