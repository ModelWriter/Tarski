...
public class mxConnectionConstraint {
   ...
   * 
   * @param point Optional mxPoint that specifies the fixed location of the point in relative
   *        coordinates. Default is null.
   * @param perimeter Optional boolean that specifies if the fixed point should be projected onto
   *        the perimeter of the terminal. Default is true.
   */
