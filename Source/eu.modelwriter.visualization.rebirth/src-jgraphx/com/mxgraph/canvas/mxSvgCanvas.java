...
/**
 * An implementation of a canvas that uses SVG for painting. This canvas ignores the
 * STYLE_LABEL_BACKGROUNDCOLOR and STYLE_LABEL_BORDERCOLOR styles due to limitations of SVG.
 */
public class mxSvgCanvas extends mxBasicCanvas {
  ...
  protected String createDataUrl(String src) throws IOException {
    ...
    if (inputStream != null) {
      ...
      result = "data:image/" + format + ";base64,"
          + mxBase64.encodeToString(outputStream.toByteArray(), false);
    }
   ...
   * 
   */
  protected Element createImageElement(double x, double y, double w, double h, String src,
      boolean aspect, boolean flipH, boolean flipV, boolean embedded) {
    Element elem = null;
  ...
  public Object drawCell(mxCellState state) {
    ...
    if (state.getAbsolutePointCount() > 1) {
      ...
      if (!mxUtils.getString(style, mxConstants.STYLE_SHAPE, "")
        ...
        int start = (int) Math
            .round(mxUtils.getInt(style, mxConstants.STYLE_STARTSIZE, mxConstants.DEFAULT_STARTSIZE)
                * scale);
  ...
  public Element drawShape(int x, int y, int w, int h, Map<String, Object> style) {
    ...
    if (shape.equals(mxConstants.SHAPE_IMAGE)) {
      ...
      if (img != null) {
        ...
        elem =
            createImageElement(x, y, w, h, img, PRESERVE_IMAGE_ASPECT, flipH, flipV, isEmbedded());
      }
    } else if (shape.equals(mxConstants.SHAPE_LINE)) {
      String direction =
          mxUtils.getString(style, mxConstants.STYLE_DIRECTION, mxConstants.DIRECTION_EAST);
      String d = null;
      ...
      String d = "M " + (x + w / 2) + " " + y + " L " + (x + w) + " " + (y + h / 2) + " L "
          + (x + w / 2) + " " + (y + h) + " L " + x + " " + (y + h / 2);
      ...
      if (direction.equals(mxConstants.DIRECTION_NORTH)
        ...
        d = "M " + (x + 0.5 * w) + " " + y + " L " + (x + w) + " " + (y + 0.25 * h) + " L "
            + (x + w) + " " + (y + 0.75 * h) + " L " + (x + 0.5 * w) + " " + (y + h) + " L " + x
            + " " + (y + 0.75 * h) + " L " + x + " " + (y + 0.25 * h);
      } else {
      ...
      String d = "M " + (x + 0.25 * w) + " " + (y + 0.25 * h) + " C " + (x + 0.05 * w) + " "
          + (y + 0.25 * h) + " " + x + " " + (y + 0.5 * h) + " " + (x + 0.16 * w) + " "
          + (y + 0.55 * h) + " C " + x + " " + (y + 0.66 * h) + " " + (x + 0.18 * w) + " "
          + (y + 0.9 * h) + " " + (x + 0.31 * w) + " " + (y + 0.8 * h) + " C " + (x + 0.4 * w) + " "
          + (y + h) + " " + (x + 0.7 * w) + " " + (y + h) + " " + (x + 0.8 * w) + " "
          + (y + 0.8 * h) + " C " + (x + w) + " " + (y + 0.8 * h) + " " + (x + w) + " "
      ...
      String d = " M " + x + " " + (y + h) + " C " + x + " " + (y + 3 * h / 5) + " " + x + " "
          + (y + 2 * h / 5) + " " + (x + w / 2) + " " + (y + 2 * h / 5) + " C "
          + (x + w / 2 - width3) + " " + (y + 2 * h / 5) + " " + (x + w / 2 - width3) + " " + y
          + " " + (x + w / 2) + " " + y + " C " + (x + w / 2 + width3) + " " + y + " "
          + (x + w / 2 + width3) + " " + (y + 2 * h / 5) + " " + (x + w / 2) + " " + (y + 2 * h / 5)
          + " C " + (x + w) + " " + (y + 2 * h / 5) + " " + (x + w) + " " + (y + 3 * h / 5) + " "
          + (x + w) + " " + (y + h);
      ...
      String d = " M " + x + " " + (y + dy) + " C " + x + " " + (y - dy / 3) + " " + (x + w) + " "
          + (y - dy / 3) + " " + (x + w) + " " + (y + dy) + " L " + (x + w) + " " + (y + h - dy)
          + " C " + (x + w) + " " + (y + h + dy / 3) + " " + x + " " + (y + h + dy / 3) + " " + x
          + " " + (y + h - dy);
      background.setAttribute("d", d + " Z");
      elem.appendChild(background);

      Element foreground = document.createElement("path");
      d = "M " + x + " " + (y + dy) + " C " + x + " " + (y + 2 * dy) + " " + (x + w) + " "
          + (y + 2 * dy) + " " + (x + w) + " " + (y + dy);
      ...
      if (shape.equals(mxConstants.SHAPE_LABEL)) {
        ...
        if (img != null) {
          ...
          Element imageElement =
              createImageElement(imageBounds.getX(), imageBounds.getY(), imageBounds.getWidth(),
        ...
        if (mxUtils.isTrue(style, mxConstants.STYLE_GLASS, false)) {
          ...
          glassOverlay.setAttribute("fill",
              "url(#" + getGlassGradientElement().getAttribute("id") + ")");
  ...
  public Element drawLine(List<mxPoint> pts, Map<String, Object> style) {
    ...
    if (strokeColor != null && strokeWidth > 0) {
      ...
      if (marker != null) {
        float size =
            (mxUtils.getFloat(style, mxConstants.STYLE_STARTSIZE, mxConstants.DEFAULT_MARKERSIZE));
      ...
      if (marker != null) {
        float size =
            (mxUtils.getFloat(style, mxConstants.STYLE_ENDSIZE, mxConstants.DEFAULT_MARKERSIZE));
   ...
   */
  public mxPoint drawMarker(Element parent, Object type, mxPoint p0, mxPoint pe, float size,
      float strokeWidth, String color) {
    mxPoint offset = null;
    ...
    if (type.equals(mxConstants.ARROW_CLASSIC) || type.equals(mxConstants.ARROW_BLOCK)) {
      ...
      d = "M " + (pe.getX() - nx - ny / 2) + " " + (pe.getY() - ny + nx / 2) + " L "
          + (pe.getX() - nx / 6) + " " + (pe.getY() - ny / 6) + " L " + (pe.getX() + ny / 2 - nx)
          + " " + (pe.getY() - ny - nx / 2) + " M " + pe.getX() + " " + pe.getY();
      path.setAttribute("fill", "none");
      ...
      d = "M " + (pe.getX() - ny / 2) + " " + (pe.getY() + nx / 2) + " a " + (absSize / 2) + " "
          + (absSize / 2) + " 0  1,1 " + (nx / 8) + " " + (ny / 8) + " z";
  ...
  public Object drawText(String text, int x, int y, int w, int h, Map<String, Object> style) {
    ...
    int fontSize =
        (int) (mxUtils.getInt(style, mxConstants.STYLE_FONTSIZE, mxConstants.DEFAULT_FONTSIZE)
            * scale);
    ...
    if (text != null && text.length() > 0) {
      ...
      String uline = ((fontStyle & mxConstants.FONT_UNDERLINE) == mxConstants.FONT_UNDERLINE)
          ? "underline" : "none";
