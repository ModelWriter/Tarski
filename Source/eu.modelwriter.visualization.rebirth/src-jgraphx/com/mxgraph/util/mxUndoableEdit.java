...
public class mxUndoableEdit {
  ...
  /**
   * Hook to notify any listeners of the changes after an undo or redo has been carried out. This
  ...
  /**
   * Hook to free resources after the edit has been removed from the command history. This
   * implementation is empty.
   */
  public void die() {
    // empty
  ...
  /**
   * Adds the specified change to this edit. The change is an object that is expected to either have
