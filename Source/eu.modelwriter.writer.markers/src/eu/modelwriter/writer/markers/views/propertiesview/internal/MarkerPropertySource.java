...
public class MarkerPropertySource implements IPropertySource {
	...
	public MarkerPropertySource(MarkElement marker,
			ArrayList<MarkElement> sources, ArrayList<MarkElement> targets) {
		this.marker = marker;
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		return new IPropertyDescriptor[] {
				new PropertyDescriptor(DETAILS, "Details"),
				new PropertyDescriptor(SOURCES, "Sources"),
				new PropertyDescriptor(TARGETS, "Targets") };
	}
