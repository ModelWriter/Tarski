...
public class PreferencesHyperlinkDetector extends AbstractHyperlinkDetector
	...
	public IHyperlink[] detectHyperlinks(ITextViewer textViewer,
		...
		try {
			...
			candidate = document.get(lineRegion.getOffset(),
		...
		if (index != -1) {
			...
			IRegion targetRegion = new Region(lineRegion.getOffset() + index,
					PREFERENCES.length());
