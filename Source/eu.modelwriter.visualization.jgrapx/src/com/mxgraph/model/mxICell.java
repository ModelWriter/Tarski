...
public interface mxICell {
   ...
   * 
   * @param source Boolean that specifies if the source terminal should be returned.
  ...
  /**
   * Inserts the specified child into the child array at the specified index and updates the parent
   * reference of the child. Returns the inserted child.
   * 
   * @param child Cell to be inserted into the child array.
   * @param index Integer that specifies the index at which the child should be inserted into the
   *        child array.
   * @return Returns the new child.
   */
  ...
  /**
   * Removes the child at the specified index from the child array and returns the child that was
   * removed. Will remove the parent reference of the child.
   * 
  ...
  /**
   * Removes the given child from the child array and returns it. Will remove the parent reference
   * of the child.
   * 
  ...
  /**
   * Inserts the specified edge into the edge array and returns the edge. Will update the respective
   * terminal reference of the edge.
   * 
  ...
  /**
   * Removes the specified edge from the edge array and returns the edge. Will remove the respective
   * terminal reference from the edge.
   * 
   ...
   * 
   * @param isSource Boolean that specifies if the edge should be removed from its source or target
   *        terminal.
   */
