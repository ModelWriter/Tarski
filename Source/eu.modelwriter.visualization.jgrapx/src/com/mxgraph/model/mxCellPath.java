...
public class mxCellPath {
  ...
  /**
   * Creates the cell path for the given cell. The cell path is a concatenation of the indices of
   * all cells on the (finite) path to the root, eg. "0.0.0.1".
   * 
  ...
  /**
   * Returns the path for the parent of the cell represented by the given path. Returns null if the
  ...
  /**
   * Compares the given cell paths and returns -1 if cp1 is smaller, 0 if cp1 is equal and 1 if cp1
   * is greater than cp2.
   */
