...
public class mxMovePreview extends mxEventSource {
  ...
  /**
   * Specifies if the placeholder rectangle should be used for all previews. Default is false. This
   * overrides all other preview settings if true.
   */
  ...
  /**
   * Specifies if connected, unselected edges should be included in the preview. Default is true.
   * This should not be used if cloning is enabled.
   */
  protected boolean contextPreview = true;

  /**
   * Specifies if the selection cells handler should be hidden while the preview is visible. Default
   * is false.
   */
   ...
   *
   */
  public Object[] stop(boolean commit, MouseEvent e, double dx, double dy, boolean clone,
      Object target) {
