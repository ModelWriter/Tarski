...
public class mxGraphOutline extends JComponent {
  ...
  /**
   * Specifies if the outline should be zoomed to the page if the graph component is in page layout
  ...
  /**
   * Paints the foreground. Foreground is dynamic and should never be made part of the triple
   * buffer. It is painted on top of the buffer.
   */
