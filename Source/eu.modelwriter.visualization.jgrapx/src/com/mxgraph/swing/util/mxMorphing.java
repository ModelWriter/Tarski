...
public class mxMorphing extends mxAnimation {
  ...
  /**
   * Ease-off for movement towards the given vector. Larger values are slower and smoother. Default
   * is 1.5.
   */
  ...
  /**
   * Optional array of cells to be animated. If this is not specified then all cells are checked and
   * animated if they have been moved in the current transaction.
   */
  ...
  /**
   * Returns true if the animation should not recursively find more deltas for children if the given
   * parent state has been animated.
   */
  ...
  /**
   * Returns the vector between the current rendered state and the future location of the state
   * after the display will be updated.
   */
