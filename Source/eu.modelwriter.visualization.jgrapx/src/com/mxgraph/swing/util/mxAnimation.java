...
/**
 * Baseclass for all timer-based animations. Fires mxEvent.DONE when the stopAnimation method is
 * called. Implement updateAnimation for the actual animation or listen to mxEvent.EXECUTE.
 */
public class mxAnimation extends mxEventSource {
   ...
   * startAnimation to resume. This is called whenever the timer fires and fires an mxEvent.EXECUTE
