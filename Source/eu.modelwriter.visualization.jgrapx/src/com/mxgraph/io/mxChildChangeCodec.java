...
/**
 * Codec for mxChildChanges. This class is created and registered dynamically at load time and used
 * implicitely via mxCodec and the mxCodecRegistry.
 */
public class mxChildChangeCodec extends mxObjectCodec {
   ...
   */
  public mxChildChangeCodec(Object template, String[] exclude, String[] idrefs,
   ...
   * (non-Javadoc)
   * 
   * @see com.mxgraph.io.mxObjectCodec#isReference(java.lang.Object, java.lang.String,
   ...
   * (non-Javadoc)
   * 
   * @see com.mxgraph.io.mxObjectCodec#afterEncode(com.mxgraph.io.mxCodec, java.lang.Object,
   * org.w3c.dom.Node)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.mxgraph.io.mxObjectCodec#afterDecode(com.mxgraph.io.mxCodec, org.w3c.dom.Node,
   * java.lang.Object)
   */
  @Override
