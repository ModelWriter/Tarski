...
/**
 * Codec for mxGraphModels. This class is created and registered dynamically at load time and used
...
public class mxModelCodec extends mxObjectCodec {
  ...
  /**
   * Encodes the given mxGraphModel by writing a (flat) XML sequence of cell nodes as produced by
   * the mxCellCodec. The sequence is wrapped-up in a node with the name root.
   */
