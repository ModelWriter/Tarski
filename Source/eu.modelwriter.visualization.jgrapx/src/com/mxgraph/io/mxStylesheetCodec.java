...
/**
 * Codec for mxStylesheets. This class is created and registered dynamically at load time and used
...
public class mxStylesheetCodec extends mxObjectCodec {
  ...
  public Node encode(mxCodec enc, Object obj) {
    ...
    if (obj instanceof mxStylesheet) {
      ...
      Iterator<Map.Entry<String, Map<String, Object>>> it =
          stylesheet.getStyles().entrySet().iterator();
  ...
  public Object decode(mxCodec dec, Node node, Object into) {
    ...
    if (node instanceof Element) {
      ...
      while (node != null) {
        if (!processInclude(dec, node, obj) && node.getNodeName().equals("add")
          ...
          if (as != null && as.length() > 0) {
            ...
            Map<String, Object> style =
                (extend != null) ? ((mxStylesheet) obj).getStyles().get(extend) : null;
