...
/**
 * Singleton class that acts as a global registry for codecs. See {@link mxCodec} for an example.
 */
public class mxCodecRegistry {
  ...
  /**
   * Holds the list of known packages. Packages are used to prefix short class names (eg. mxCell) in
   * XML markup.
   */
  ...
  /**
   * Registers a new codec and associates the name of the template constructor in the codec with the
   * codec object. Automatically creates an alias if the codename and the classname are not equal.
   */
   ...
   *
   * The I/O system uses unqualified classnames, eg. for a <code>com.mxgraph.model.mxCell</code>
   * this returns <code>mxCell</code>.
   * 
