...
/**
 * A converter that renders display XML data onto a graphics canvas. This reader can only be used to
 * generate images for encoded graph views.
 */
public class mxGraphViewImageReader extends mxGraphViewReader {
  ...
  public mxICanvas createCanvas(Map<String, Object> attrs) {
    ...
    mxImageCanvas canvas =
        new mxImageCanvas(createGraphicsCanvas(), width, height, getBackground(), isAntiAlias());
  ...
  /**
   * Creates the image for the given display XML file. (Note: The XML file is an encoded
