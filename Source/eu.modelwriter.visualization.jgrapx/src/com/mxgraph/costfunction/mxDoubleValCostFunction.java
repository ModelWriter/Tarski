/**
 * Copyright (c) 2012, JGraph Ltd Returns the value of a cell, which is assumed a Double
 */
...
/**
 * A cost function that assumes that edge value is of type "double" or "String" and returns that
 * value. Default edge weight is 1.0 (if no double value can be retrieved)
 */
