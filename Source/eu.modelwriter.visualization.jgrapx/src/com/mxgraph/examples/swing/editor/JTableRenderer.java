...
public class JTableRenderer extends JComponent {
  ...
  /**
   * Implements an event redirector for the specified handle index, where 0 is the top right, and
   * 1-7 are the top center, rop right, middle left, middle right, bottom left, bottom center and
   * bottom right, respectively. Default index is 7 (bottom right).
   */
  public class ResizeHandler implements MouseListener, MouseMotionListener {
    ...
    public void mouseReleased(MouseEvent e) {
      graphContainer.getGraphControl().dispatchEvent(SwingUtilities
          .convertMouseEvent((Component) e.getSource(), e, graphContainer.getGraphControl()));
    }
