...
public class SchemaEditorMenuBar extends JMenuBar {
  ...
  public SchemaEditorMenuBar(final BasicGraphEditor editor) {
    ...
    item = submenu.add(new TogglePropertyItem(graphComponent, mxResources.get("centerPage"),
    ...
    submenu.add(
        editor.bind(mxResources.get("tolerance"), new PromptPropertyAction(graph, "Tolerance")));
