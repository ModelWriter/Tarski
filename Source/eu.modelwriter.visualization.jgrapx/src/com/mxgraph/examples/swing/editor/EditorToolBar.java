...
public class EditorToolBar extends JToolBar {
  ...
  public EditorToolBar(final BasicGraphEditor editor, int orientation) {
    ...
    fonts.addAll(Arrays.asList(
        new String[] {"Helvetica", "Verdana", "Times New Roman", "Garamond", "Courier New", "-"}));
    ...
    final JComboBox sizeCombo = new JComboBox(new Object[] {"6pt", "8pt", "9pt", "10pt", "12pt",
    ...
    final JComboBox zoomCombo = new JComboBox(new Object[] {"400%", "200%", "150%", "100%", "75%",
