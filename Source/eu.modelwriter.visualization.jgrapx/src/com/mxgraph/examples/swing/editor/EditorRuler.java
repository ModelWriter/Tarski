...
public class EditorRuler extends JComponent implements MouseMotionListener, DropTargetListener {
  ...
  /**
   * Specified that start and length of the active region, ie the region to paint with the
   * background border. This is used for example to indicate the printable region of a graph.
   */
  ...
  /**
   * Returns the preferred size by replacing the respective component of the graph's preferred size
   * with {@link #rulerSize}.
   * 
