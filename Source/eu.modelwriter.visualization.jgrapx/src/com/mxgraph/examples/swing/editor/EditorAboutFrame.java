...
public class EditorAboutFrame extends JDialog {
  ...
  public EditorAboutFrame(Frame owner) {
    ...
    buttonPanel.setBorder(
        BorderFactory.createCompoundBorder(BorderFactory.createMatteBorder(1, 0, 0, 0, Color.GRAY),
  ...
  /**
   * Overrides {@link JDialog#createRootPane()} to return a root pane that hides the window when the
   * user presses the ESCAPE key.O
   */
