...
public class GraphConfigDialog extends JDialog {
    ...
    if ((graphType2 == GraphType.NULL) || (graphType2 == GraphType.SIMPLE_RANDOM_TREE)) {
        ...
        public void actionPerformed(ActionEvent e) {
          ...
          if (graphType2 == GraphType.NULL) {
            ...
            mxGraphGenerator generator =
                new mxGraphGenerator(mxGraphGenerator.getGeneratorFunction(graph, false, 0, 10),
      ...
      applyButton.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          ...
          graph.removeCells();
          mxGraphGenerator generator =
              new mxGraphGenerator(mxGraphGenerator.getGeneratorFunction(graph, weighted,
      ...
      // setLocationRelativeTo(parent);
        ...
        || graphType2 == GraphType.FRIENDSHIP_WINDMILL) {
      ...
      applyButton.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          ...
          if (graphType2 == GraphType.FRIENDSHIP_WINDMILL) {
            generator.getFriendshipWindmillGraph(aGraph, numBranchesParam,
                numVertexesInBranchParam);
          } else if (graphType2 == GraphType.FULL_WINDMILL) {
            generator.getWindmillGraph(aGraph, numBranchesParam, numVertexesInBranchParam);
          }

          generator.setWindmillGraphLayout(aGraph, numBranchesParam, numVertexesInBranchParam,
              1000);
          mxGraphStructure.setDefaultGraphStyle(aGraph, false);
          setVisible(false);
        }
      ...
      applyButton.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          ...
          generator.setBipartiteGraphSpacing(aGraph, leftNodeCount, rightNodeCount, spacing,
              spacing * 2);
          mxGraphStructure.setDefaultGraphStyle(aGraph, false);
          setVisible(false);
          graph.getModel().endUpdate();
      ...
      panel.add(forceConnectedBox =
          new JCheckBox("Always connected (edge count may be inaccurate)", false));
      JPanel panelBorder = new JPanel();
      panelBorder.setBorder(new EmptyBorder(10, 10, 10, 10));
      panelBorder.add(panel);
      ...
      applyButton.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          ...
          generator.getSimpleRandomGraph(aGraph, nodeCount, edgeCount, allowSelfLoops,
              allowMultipleEdges, forceConnected);
      ...
      applyButton.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          ...
          if (startVertex == null) {
            ...
            System.out.println("Indegree of " + aGraph.getGraph().getModel().getValue(startVertex)
                + " is " + indegree);
          } else if (graphType2 == GraphType.OUTDEGREE) {
            int outdegree = mxGraphStructure.outdegree(aGraph, startVertex);
            System.out.println("Outdegree of " + aGraph.getGraph().getModel().getValue(startVertex)
                + " is " + outdegree);
  ...
  public void configAnalysisGraph(mxGraph graph, mxGraphGenerator generator,
