...
public class mxHtmlCanvas extends mxBasicCanvas {
  ...
  public Element drawShape(int x, int y, int w, int h, Map<String, Object> style) {
    ...
    if (mxUtils.isTrue(style, mxConstants.STYLE_SHADOW, false) && fillColor != null) {
      ...
      String s = "overflow:hidden;position:absolute;" + "left:"
          + String.valueOf(x + mxConstants.SHADOW_OFFSETX) + "px;" + "top:"
          + String.valueOf(y + mxConstants.SHADOW_OFFSETY) + "px;" + "width:" + String.valueOf(w)
          + "px;" + "height:" + String.valueOf(h) + "px;background:" + mxConstants.W3C_SHADOWCOLOR
  ...
  public void drawLine(List<mxPoint> pts, Map<String, Object> style) {
    ...
    if (strokeColor != null && strokeWidth > 0) {
      ...
      for (int i = 1; i < pts.size(); i++) {
        ...
        drawSegment((int) last.getX(), (int) last.getY(), (int) pt.getX(), (int) pt.getY(),
  ...
  protected void drawSegment(int x0, int y0, int x1, int y1, String strokeColor, int strokeWidth) {
    ...
    if (width == 0 || height == 0) {
      String s = "overflow:hidden;position:absolute;" + "left:" + String.valueOf(x0) + "px;"
          + "top:" + String.valueOf(y0) + "px;" + "width:" + String.valueOf(width) + "px;"
          + "height:" + String.valueOf(height) + "px;" + "border-color:" + strokeColor + ";"
