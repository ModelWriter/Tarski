...
public interface mxIGraphLayout {
  ...
  /**
   * Notified when a cell is being moved in a parent that has automatic layout to update the cell
   * state (eg. index) so that the outcome of the layout will position the vertex as close to the
