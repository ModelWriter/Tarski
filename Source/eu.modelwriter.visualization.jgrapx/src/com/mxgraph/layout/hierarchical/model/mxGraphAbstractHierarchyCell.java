...
public abstract class mxGraphAbstractHierarchyCell {
   ...
   * stages. Currently, the longest path layering sets temp to the rank position in fixRanks() and
   * the crossing reduction uses this. This meant temp couldn't be used for hashing the nodes in the
   * model dfs and so hashCode was created
   */
