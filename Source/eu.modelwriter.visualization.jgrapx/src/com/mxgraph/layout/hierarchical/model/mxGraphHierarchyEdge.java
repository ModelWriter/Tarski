...
public class mxGraphHierarchyEdge extends mxGraphAbstractHierarchyCell {
  ...
  /**
   * The graph edge(s) this object represents. Parallel edges are all grouped together within one
   * hierarchy edge.
   */
  ...
  /**
   * Whether or not the direction of this edge has been reversed internally to create a DAG for the
   * hierarchical layout
   */
