...
/**
 * An implementation of the first stage of the Sugiyama layout. Straightforward longest path
 * calculation of layer assignment
 */
public class mxMinimumCycleRemover implements mxHierarchicalLayoutStage {
  ...
  public void execute(Object parent) {
    ...
    final Set<mxGraphHierarchyNode> unseenNodes =
        new HashSet<mxGraphHierarchyNode>(model.getVertexMapper().values());
