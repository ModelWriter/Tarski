...
public class mxGraphProperties {
  ...
  /**
   * Whether or not to navigate the graph raw graph structure or the visible structure. The value
   * associated with this key should evaluate as a string to <code>1</code> or <code>0</code>
   */
  ...
  /**
   * Whether or not to take into account the direction on edges. The value associated with this key
   * should evaluate as a string to <code>1</code> or <code>0</code>
   */
