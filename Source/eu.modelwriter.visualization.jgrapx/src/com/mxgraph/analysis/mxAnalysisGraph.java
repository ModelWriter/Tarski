...
/**
 * Implements a collection of utility methods abstracting the graph structure taking into account
 * graph properties such as visible/non-visible traversal
 */
public class mxAnalysisGraph {
   ...
   */
  public Object[] getEdges(Object cell, Object parent, boolean incoming, boolean outgoing,
      boolean includeLoops, boolean recurse) {
