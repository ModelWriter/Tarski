 ...
 * All rights reserved.
 * 
 * See LICENSE file for license details. If you are unable to locate this file please contact info
 * (at) jgraph (dot) com.
 */
 ...
 * 
 * mxEvent.UNDO fires after the selection was changed in changeSelection. The <code>edit</code>
 * property contains the mxUndoableEdit which contains the mxSelectionChange.
 * 
 * mxEvent.CHANGE fires after the selection changes by executing an mxSelectionChange. The
 * <code>added</code> and <code>removed</code> properties contain Collections of cells that have
 * been added to or removed from the selection, respectively.
 * 
...
public class mxGraphSelectionModel extends mxEventSource {
  ...
  public static class mxSelectionChange implements mxUndoableChange {
     ...
     * @param removed
     */
    public mxSelectionChange(mxGraphSelectionModel model, Collection<Object> added,
