...
/**
 * Defines the appearance of the cells in a graph. The following example changes the font size for
 * all vertices by changing the default vertex style in-place: <code>
...
public class mxStylesheet {
  ...
  /**
   * Returns the cell style for the specified cell or the given defaultStyle if no style can be
   * found for the given stylename.
   * 
