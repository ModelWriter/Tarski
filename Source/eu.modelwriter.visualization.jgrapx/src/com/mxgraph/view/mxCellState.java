...
public class mxCellState extends mxRectangle {
  ...
  /**
   * Holds the absolute offset. For edges, this is the absolute coordinates of the label position.
  ...
  /**
   * Constructs a new object that represents the current state of the given cell in the specified
   * view.
   * 
  ...
  /**
   * Returns the rectangle that should be used as the perimeter of the cell. This implementation
   * adds the perimeter spacing to the rectangle defined by this cell state.
   * 
   ...
   * 
   * @param Boolean that specifies if the source or target state should be returned.
   */
