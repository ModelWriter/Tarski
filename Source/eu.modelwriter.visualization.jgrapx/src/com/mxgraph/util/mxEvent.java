...
public class mxEvent {
  ...
  /**
   * Holds the name for the change event. First and only argument in the argument array is the list
   * of mxAtomicGraphChanges that have been executed on the model.
   */
  public static final String CHANGE = "change";

  /**
   * Holds the name for the execute event. First and only argument in the argument array is the
   * mxAtomicGraphChange that has been executed on the model. This event fires before the change
   * event.
   */
  public static final String EXECUTE = "execute";

  /**
   * Holds the name for the beforeUndo event. First and only argument in the argument array is the
   * current edit that is currently in progress in the model. This event fires before notify is
   * called on the currentEdit in the model.
   */
  public static final String BEFORE_UNDO = "beforeUndo";

  /**
   * Holds the name for the norify event. First and only argument in the argument array is the list
   * of mxAtomicGraphChanges that have been executed on the model. This event fires after the change
   * event.
   */
  public static final String NOTIFY = "notify";

  /**
   * Holds the name for the beginUpdate event. This event has no arguments and fires after the
   * updateLevel has been changed in model.
   */
  public static final String BEGIN_UPDATE = "beginUpdate";

  /**
   * Holds the name for the endUpdate event. This event has no arguments and fires after the
   * updateLevel has been changed in the model. First argument is the currentEdit.
   */
  ...
  /**
   * Holds the name for the mark event, which fires after a cell has been marked. First and only
   * argument in the array is the cell state that has been marked or null, if no state has been
   * marked.
   * 
