 ...
 * 
 * mxEvent.UNDO fires afer a significant edit was undone in undo. The <code>edit</code> property
 * contains the mxUndoableEdit that was undone.
 * 
 * mxEvent.REDO fires afer a significant edit was redone in redo. The <code>edit</code> property
 * contains the mxUndoableEdit that was redone.
 * 
 * mxEvent.ADD fires after an undoable edit was added to the history. The <code>edit</code> property
 * contains the mxUndoableEdit that was added.
 */
public class mxUndoManager extends mxEventSource {
   ...
   * This is called from undoableEditHappened.
   */
  protected void trim() {
