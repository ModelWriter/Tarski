...
public class mxRectangle extends mxPoint {
  ...
  /**
   * Grows the rectangle by the given amount, that is, this method subtracts the given amount from
   * the x- and y-coordinates and adds twice the amount to the width and height.
   *
  ...
  /**
   * Returns the point at which the specified point intersects the perimeter of this rectangle or
   ...
   * @return the point at which the line intersects this rectangle, or null if there is no
   *         intersection
   */
  ...
  /**
   * Returns the <code>String</code> representation of this <code>mxRectangle</code>.
   * 
