...
public class mxEventSource {
  ...
  /**
   * Holds the event names and associated listeners in an array. The array contains the event name
   * followed by the respective listener for each registered listener.
   */
  ...
  /**
   * Dispatches the given event name, passing all arguments after the given name to the registered
