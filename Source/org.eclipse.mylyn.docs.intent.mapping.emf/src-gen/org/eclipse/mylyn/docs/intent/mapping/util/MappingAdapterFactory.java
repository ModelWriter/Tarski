...
public class MappingAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * {@link org.eclipse.mylyn.docs.intent.mapping.IBaseElement <em>IBase Element</em>}'. <!-- begin-user-doc
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.mylyn.docs.intent.mapping.TextLocation <em>Text Location</em>}'. <!-- begin-user-doc
	 * --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore
	 * a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
