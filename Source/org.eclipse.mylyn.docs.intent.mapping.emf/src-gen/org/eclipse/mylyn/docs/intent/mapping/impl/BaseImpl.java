...
public class BaseImpl extends MinimalEObjectImpl.Container implements Base {
	 ...
	 * @generated NOT
	 */
	private final LocationFactory factory = initLocationFactory();

	private LocationFactory initLocationFactory() {
		LocationFactory res = new LocationFactory();

		res.addClassInstance(ITextLocation.class, TextLocationImpl.class);
	 ...
	 * {@inheritDoc}
	 *
	 * @see org.eclipse.mylyn.docs.intent.mapping.IBase#getLocationFactory()
	 * @generated NOT
	 */
