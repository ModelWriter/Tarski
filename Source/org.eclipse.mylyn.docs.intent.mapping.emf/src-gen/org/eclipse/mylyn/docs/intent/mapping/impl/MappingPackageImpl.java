...
import org.eclipse.mylyn.docs.intent.mapping.IBaseElement;
...
public class MappingPackageImpl extends EPackageImpl implements MappingPackage {
	 ...
	 * @generated
	 */
	private EClass iBaseElementEClass = null;
	 ...
	 * @generated
	 */
	public EReference getScope_Locations() {
	 ...
	 * @generated
	 */
	public EReference getScope_Holder() {
	 ...
	 * @generated
	 */
	public EClass getIBaseElement() {
		return iBaseElementEClass;
	}
	...
	public void createPackageContents() {
		...
		createEReference(scopeEClass, SCOPE__LOCATIONS);
		createEReference(scopeEClass, SCOPE__HOLDER);
		...
		iBaseElementEClass = createEClass(IBASE_ELEMENT);
	...
	public void initializePackageContents() {
		...
		locationEClass.getESuperTypes().add(this.getIBaseElement());
		scopeEClass.getESuperTypes().add(this.getIBaseElement());
		linkEClass.getESuperTypes().add(this.getIBaseElement());
		baseEClass.getESuperTypes().add(this.getIBaseElement());
		...
		initEClass(scopeEClass, Scope.class, "Scope", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getScope_Locations(), this.getLocation(), this.getLocation_ReferencingScopes(),
				"locations", null, 1, -1, Scope.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScope_Holder(), this.getLocation(), this.getLocation_Scope(), "holder", null, 1, 1,
		...
		initEClass(iBaseElementEClass, IBaseElement.class, "IBaseElement", IS_ABSTRACT, IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
