	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MappingPackage.LOCATION: {
				...
				if (result == null)
					result = caseIBaseElement(location);
				if (result == null)
			...
			case MappingPackage.BASE: {
				...
				if (result == null)
					result = caseIBaseElement(base);
				if (result == null)
					result = defaultCase(theEObject);
				return result;
			}
			case MappingPackage.IBASE_ELEMENT: {
				IBaseElement iBaseElement = (IBaseElement)theEObject;
				T result = caseIBaseElement(iBaseElement);
				if (result == null)
					result = defaultCase(theEObject);
				return result;
			}
			case MappingPackage.TEXT_LOCATION: {
				...
				if (result == null)
					result = caseIBaseElement(textLocation);
				if (result == null)
					result = defaultCase(theEObject);
				return result;
			}
