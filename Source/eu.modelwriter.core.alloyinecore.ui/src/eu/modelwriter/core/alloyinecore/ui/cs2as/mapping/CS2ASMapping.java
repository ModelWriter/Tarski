...
enum Qualification {
  ...
  public String getAnnotationSource() {
    switch (this) {
      case VISIBILITY:
        return "http://www.modelwriter.eu/AlloyInEcore/Visibility";
      case STATIC:
        return "http://www.modelwriter.eu/AlloyInEcore/Static";
      case PRIMITIVE:
        return "http://www.modelwriter.eu/AlloyInEcore/DataType/Primitive";
      case DERIVED:
      case ORDERED:
      case UNIQUE:
      case ID:
      ...
      case COMPOSES:
      case RESOLVE:
        return "http://www.modelwriter.eu/AlloyInEcore/Qualifier";
      default:
        return null;
    }
  }
...
public class CS2ASMapping extends AlloyInEcoreBaseVisitor<Object> {
  ...
  private EDataType createEDataType(final EDataTypeContext ctx) {
    ...
    // TODO OWNED CONSTRAINTS = INVARIANT CONSTRAINT*
