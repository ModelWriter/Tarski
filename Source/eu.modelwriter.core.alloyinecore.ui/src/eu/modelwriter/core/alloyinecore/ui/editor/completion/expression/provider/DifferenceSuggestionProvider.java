...
public class DifferenceSuggestionProvider extends AbstractAIESuggestionProvider {
    ...
    if (lastToken instanceof ParserRuleContext) {
      if (lastToken instanceof ExpressionContext) {
        if (((UnionContext) context).left != null
          ...
          suggestions.add(ExpressionCompletionTokens._difference);
      ...
      if (lastToken.getText().equals(ExpressionCompletionTokens._difference)) {
  ...
  protected boolean isCompatibleWithContext(final ParserRuleContext context) {
    return context instanceof DifferenceContext;
  }
