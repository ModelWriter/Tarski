...
public class PostconditionSuggestionProvider extends AbstractAIESuggestionProvider {
  ...
  public Set<String> getStartSuggestions() {
    ...
    startSuggestions.add(ModelCompletionTokens._postcondition);
    startSuggestions.add(ModelCompletionTokens._ensures);
  ...
  protected void computeSuggestions(final ParserRuleContext context, final ParseTree lastToken) {
    if (lastToken instanceof ParserRuleContext) {
      ...
      if (lastToken.getText().equals(ModelCompletionTokens._postcondition)
          || lastToken.getText().equals(ModelCompletionTokens._ensures)) {
        suggestions.add(ModelCompletionTokens._colon);
        suggestions.add(ModelCompletionTokens._semicolon);
