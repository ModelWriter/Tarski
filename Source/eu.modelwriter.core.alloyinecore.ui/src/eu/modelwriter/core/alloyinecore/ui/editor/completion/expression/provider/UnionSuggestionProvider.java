...
public class UnionSuggestionProvider extends AbstractAIESuggestionProvider {
    ...
    if (lastToken instanceof ParserRuleContext) {
      if (lastToken instanceof ExpressionContext) {
        if (((UnionContext) context).left != null
          ...
          suggestions.add(ExpressionCompletionTokens._union);
      ...
      if (lastToken.getText().equals(ExpressionCompletionTokens._union)) {
  ...
  protected boolean isCompatibleWithContext(final ParserRuleContext context) {
    return context instanceof UnionContext;
  }
