...
public class OverrideSuggestionProvider extends AbstractAIESuggestionProvider {
    ...
    if (lastToken instanceof ParserRuleContext) {
      if (lastToken instanceof ExpressionContext) {
        if (((UnionContext) context).left != null
          ...
          suggestions.add(ExpressionCompletionTokens._override);
      ...
      if (lastToken.getText().equals(ExpressionCompletionTokens._override)) {
  ...
  protected boolean isCompatibleWithContext(final ParserRuleContext context) {
    return context instanceof OverrideContext;
  }
