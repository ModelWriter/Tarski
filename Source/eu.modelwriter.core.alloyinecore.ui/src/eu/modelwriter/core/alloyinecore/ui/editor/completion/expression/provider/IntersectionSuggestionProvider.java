...
public class IntersectionSuggestionProvider extends AbstractAIESuggestionProvider {
    ...
    if (lastToken instanceof ParserRuleContext) {
      if (lastToken instanceof ExpressionContext) {
        if (((UnionContext) context).left != null
          ...
          suggestions.add(ExpressionCompletionTokens._intersection);
      ...
      if (lastToken.getText().equals(ExpressionCompletionTokens._intersection)) {
  ...
  protected boolean isCompatibleWithContext(final ParserRuleContext context) {
    return context instanceof IntersectionContext;
  }
