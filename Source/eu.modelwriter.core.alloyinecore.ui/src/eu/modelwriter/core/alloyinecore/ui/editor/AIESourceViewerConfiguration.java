...
import eu.modelwriter.core.alloyinecore.ui.editor.scanner.AbstractAIEScanner;
...
public class AIESourceViewerConfiguration extends TextSourceViewerConfiguration {
  ...
  private AbstractAIEScanner fCodeScanner;
  ...
  private void initializeScanners() {
    fCodeScanner = new AIECodeScanner(getColorManager(), fPreferenceStore);
  }
  ...
  public IPresentationReconciler getPresentationReconciler(final ISourceViewer sourceViewer) {
    ...
    final DefaultDamagerRepairer dr = new DefaultDamagerRepairer(getCodeScanner());
    reconciler.setDamager(dr, IAIEPartitions.AIE_MODULE);
    reconciler.setRepairer(dr, IAIEPartitions.AIE_MODULE);
   ...
   */
  protected AbstractAIEScanner getCodeScanner() {
    return fCodeScanner;
  }
