...
public class mxLine extends mxPoint {
  ...
  /**
   * Returns the square of the shortest distance from a point to this line. The line is considered
   * extrapolated infinitely in both directions for the purposes of the calculation.
   *
  ...
  public double ptLineDistSq(mxPoint pt) {
    return new Line2D.Double(getX(), getY(), endPoint.getX(), endPoint.getY())
        .ptLineDistSq(pt.getX(), pt.getY());
  }
