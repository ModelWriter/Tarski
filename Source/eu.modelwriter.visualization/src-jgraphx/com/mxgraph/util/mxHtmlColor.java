...
public class mxHtmlColor {
  ...
  /**
   * Convert a string representing a 24/32bit hex color value into a Color object. All 147 CSS color
   * names and none are also supported. None returns null. Examples of possible hex color values
   * are: #C3D9FF, #6482B9 and #774400, but note that you do not include the "#" in the string
   * passed in
   * 
