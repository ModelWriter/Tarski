...
public class mxUtils {
  ...
  /**
   * Returns the size for the given label. If isHtml is true then any HTML markup in the label is
   * computed as HTML and all newlines inside the HTML body are converted into linebreaks.
   */
  public static mxRectangle getLabelSize(String label, Map<String, Object> style, boolean isHtml,
      double scale) {
   ...
   */
  public static mxRectangle getLabelSize(String label, Map<String, Object> style, boolean isHtml,
      double scale, double htmlWrapWidth) {
    mxRectangle size;
   ...
   */
  public static mxRectangle getLabelPaintBounds(String label, Map<String, Object> style,
      boolean isHtml, mxPoint offset, mxRectangle vertexBounds, double scale) {
   ...
   */
  public static mxRectangle getLabelPaintBounds(String label, Map<String, Object> style,
      boolean isHtml, mxPoint offset, mxRectangle vertexBounds, double scale, boolean isEdge) {
    double wrapWidth = 0;
  ...
  /**
   * Returns the bounds for a label for the given location and size, taking into account the
   * alignment and spacing in the specified style, as well as the width and height of the rectangle
   * that contains the label. (For edge labels this width and height is 0.) The scale is used to
   * scale the given size and the spacings in the specified style.
   */
  public static mxRectangle getScaledLabelBounds(double x, double y, mxRectangle size,
      double outerWidth, double outerHeight, Map<String, Object> style, double scale) {
  ...
  /**
   * Returns the specified text in lines that fit within the specified width when the specified font
   * metrics are applied to the text
   * 
   ...
   */
  public static mxRectangle getSizeForHtml(String markup, Map<String, Object> style, double scale,
      double wrapWidth) {
    ...
    if (textRenderer != null) {
      ...
      if (wrapWidth > 0) {
        textRenderer.setText(createHtmlDocument(style, markup, 1,
  ...
  /**
   * Find the first character matching the input character in the given string where the character
   * has no letter preceding it.
   * 
   ...
   * @return the position of the first character matching the input character in the given string
  ...
  /**
   * Finds the index of the nearest segment on the given cell state for the specified coordinate
   * pair.
   */
   ...
   * 
   * @param terminal the cached cell state of the cell to determine the port constraints for
   * @param edge the edge connected to the constrained terminal
   * @param source whether or not the edge specified is connected to the terminal specified at its
   *        source end
  ...
  /**
   * Creates a new list of new points obtained by translating the points in the given list by the
   * given vector. Elements that are not mxPoints are added to the result as-is.
   */
   ...
   */
  public static mxPoint intersection(double x0, double y0, double x1, double y1, double x2,
  ...
  public static Collection<Object> sortCells(Collection<Object> cells, final boolean ascending) {
    SortedSet<Object> result = new TreeSet<Object>(new Comparator<Object>() {
      public int compare(Object o1, Object o2) {
        int comp =
            mxCellPath.compare(mxCellPath.create((mxICell) o1), mxCellPath.create((mxICell) o2));
  ...
  /**
   * Returns the index of the given object in the given array of -1 if the object is not contained
   * in the array.
   */
  ...
  /**
   * Returns the stylename in a style of the form stylename[;key=value] or an empty string if the
   * given style does not contain a stylename.
   * 
  ...
  /**
   * Returns the stylenames in a style of the form stylename[;key=value] or an empty array if the
   * given style does not contain any stylenames.
   * 
  ...
  /**
   * Returns the index of the given stylename in the given style. This returns -1 if the given
   * stylename does not occur (as a stylename) in the given style, otherwise it returns the index of
   * the first character.
   * 
  ...
  /**
   * Assigns the value for the given key in the styles of the given cells, or removes the key from
   * the styles if the value is null.
   * 
  ...
  /**
   * Adds or removes the given key, value pair to the style and returns the new style. If value is
   * null or zero length then the key is removed from the style.
   * 
  ...
  /**
   * Sets or toggles the flag bit for the given key in the cell's styles. If value is null then the
   * flag is toggled.
   * 
   * <code>
   ...
   *             (Jan 2012)
   */
  public static void setCellStyleFlags(mxIGraphModel model, Object[] cells, String key, int flag,
      Boolean value) {
    mxStyleUtils.setCellStyleFlags(model, cells, key, flag, value);
  }

  /**
   * Sets or removes the given key from the specified style and returns the new style. If value is
   * null then the flag is toggled.
   * 
   * @param style String of the form stylename[;key=value].
   * @param key Key of the style to be changed.
   * @param flag Integer for the bit to be changed.
   ...
   */
  public static boolean intersectsHotspot(mxCellState state, int x, int y, double hotspot, int min,
      int max) {
    if (hotspot > 0) {
      ...
      if (mxUtils.getString(state.getStyle(), mxConstants.STYLE_SHAPE, "")
          .equals(mxConstants.SHAPE_SWIMLANE)) {
        int start = mxUtils.getInt(state.getStyle(), mxConstants.STYLE_STARTSIZE,
  ...
  /**
   * Returns true if the dictionary contains true for the given key or false if no value is defined
   * for the key.
   * 
  ...
  /**
   * Returns true if the dictionary contains true for the given key or the given default value if no
  ...
  /**
   * Returns the value for key in dictionary as an int or the given default value if no value is
   * defined for the key.
   * 
   * @param dict Dictionary that contains the key, value pairs.
   * @param key Key whose value should be returned.
  ...
  /**
   * Returns the value for key in dictionary as a float or the given default value if no value is
   * defined for the key.
   * 
   * @param dict Dictionary that contains the key, value pairs.
   * @param key Key whose value should be returned.
  ...
  /**
   * Returns the value for key in dictionary as a float array or the given default value if no value
  ...
  /**
   * Returns the value for key in dictionary as a double or the given default value if no value is
   * defined for the key.
   * 
   * @param dict Dictionary that contains the key, value pairs.
   * @param key Key whose value should be returned.
  ...
  /**
   * Returns the value for key in dictionary as a string or the given default value if no value is
   * defined for the key.
   * 
   * @param dict Dictionary that contains the key, value pairs.
   * @param key Key whose value should be returned.
  ...
  /**
   * Returns the value for key in dictionary as a color or the given default value if no value is
   * defined for the key.
   * 
   * @param dict Dictionary that contains the key, value pairs.
   * @param key Key whose value should be returned.
  ...
  public static Font getFont(Map<String, Object> style, double scale) {
    String fontFamily =
        getString(style, mxConstants.STYLE_FONTFAMILY, mxConstants.DEFAULT_FONTFAMILY);
    ...
    swingFontStyle += ((fontStyle & mxConstants.FONT_ITALIC) == mxConstants.FONT_ITALIC)
   ...
   * color names are also supported: white, black, red, green, blue, orange, yellow, pink,
   * turquoise, gray and none (null). Examples of possible hex color values are: #C3D9FF, #6482B9
   * and #774400, but note that you do not include the "#" in the string passed in
   * 
  ...
  /**
   * Convert a string representing a dash pattern into a float array. A valid dash pattern is a
   * string of dash widths (floating point values) separated by space characters.
   * 
   * @param dashPatternString the string representing the dash pattern
   * @return float[]
   * @exception NumberFormatException if any of the dash widths cannot be interpreted as a floating
   *            point number
   */
  ...
  /**
   * Returns true if the user object is an XML node with the specified type and and the optional
   * attribute has the specified value or is not specified.
   * 
   * @param value Object that should be examined as a node.
   * @param nodeName String that specifies the node name.
   * @return Returns true if the node name of the user object is equal to the given type.
   */
  ...
  /**
   * Returns true if the given value is an XML node with the node name and if the optional attribute
   ...
   */
  public static boolean isNode(Object value, String nodeName, String attributeName,
  ...
  public static void setAntiAlias(Graphics2D g, boolean antiAlias, boolean textAntiAlias) {
    ...
    g.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING, (textAntiAlias)
  ...
  /**
   * Creates a buffered image for the given parameters. If there is not enough memory to create the
   * image then a OutOfMemoryError is thrown.
   */
  ...
  /**
   * Creates a table for the given text using the given document to create the DOM nodes. Returns
   * the outermost table node.
   */
  public static Element createTable(Document document, String text, int x, int y, int w, int h,
      double scale, Map<String, Object> style) {
    ...
    if (text != null && text.length() > 0) {
      ...
      td.setAttribute("align",
          mxUtils.getString(style, mxConstants.STYLE_ALIGN, mxConstants.ALIGN_CENTER));

      String fontColor = getString(style, mxConstants.STYLE_FONTCOLOR, "black");
      String fontFamily =
          getString(style, mxConstants.STYLE_FONTFAMILY, mxConstants.DEFAULT_FONTFAMILIES);
      int fontSize =
          (int) (getInt(style, mxConstants.STYLE_FONTSIZE, mxConstants.DEFAULT_FONTSIZE) * scale);

      String s = "position:absolute;" + "left:" + String.valueOf(x) + "px;" + "top:"
          + String.valueOf(y) + "px;" + "width:" + String.valueOf(w) + "px;" + "height:"
          + String.valueOf(h) + "px;" + "font-size:" + String.valueOf(fontSize) + "px;"
  ...
  /**
   * Returns a new, empty DOM document. The head argument can be used to provide an optional HEAD
   * section without the HEAD tags as follows:
   * 
   * <pre>
   ...
   */
  public static String createHtmlDocument(Map<String, Object> style, String text, double scale,
      int width, String head, String bodyCss) {
  ...
  /**
   * Evaluates a Java expression as a class member using mxCodecRegistry. The range of supported
   * expressions is limited to static class members such as mxEdgeStyle.ElbowConnector.
   */
  ...
  /**
   * Converts the ampersand, quote, prime, less-than and greater-than characters to their
   * corresponding HTML entities in the given string.
   */
  ...
  /**
   * Returns a pretty-printed XML string for the given node. Note that this string should only be
   * used for humans to read (eg. debug output) but not for further processing as it does not use
   * built-in mechanisms.
   * 
   * @param node Node to return the XML for.
