...
public class mxGdCodec {
          ...
          case PARSING_NODES: {
            if (line.startsWith("# Edges")) {
              ...
              if (items.length != 5) {
                ...
                Object vertex = graph.insertVertex(parent, label, label, x - width / 2.0,
  ...
  /**
   * Generates a GD text output with the cells in the graph. The implementation only uses the cells
   * located in the default parent.
   * 
