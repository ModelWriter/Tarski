...
public class mxSwingConstants {
   ...
   */
  public static Stroke EDGE_SELECTION_STROKE = new BasicStroke(1, BasicStroke.CAP_BUTT,
   ...
   */
  public static Stroke VERTEX_SELECTION_STROKE = new BasicStroke(1, BasicStroke.CAP_BUTT,
      BasicStroke.JOIN_MITER, 10.0f, new float[] {3, 3}, 0.0f);

  /**
   * Defines the stroke used for painting the preview for new and existing edges that are being
   * changed. Default is a dashed line.
   */
  public static Stroke PREVIEW_STROKE = new BasicStroke(1, BasicStroke.CAP_BUTT,
      BasicStroke.JOIN_MITER, 10.0f, new float[] {3, 3}, 0.0f);

  /**
   * Defines the border used for painting the preview when vertices are being resized, or cells and
   * labels are being moved.
   */
