 ...
 * </p>
 * <ul>
 *   <li>{@link AlloyXSDFile.impl.TupleTypeImpl#getAtom <em>Atom</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleTypeImpl extends MinimalEObjectImpl.Container implements TupleType {
  ...
  public EList<AtomType> getAtom() {
    if (atom == null) {
      atom = new EObjectContainmentEList<AtomType>(AtomType.class, this, AlloyXSDFilePackage.TUPLE_TYPE__ATOM);
    }
    return atom;
  }
