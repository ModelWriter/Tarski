 ...
 * </p>
 * <ul>
 *   <li>{@link AlloyXSDFile.impl.AlloyTypeImpl#getInstance <em>Instance</em>}</li>
 *   <li>{@link AlloyXSDFile.impl.AlloyTypeImpl#getBuilddate <em>Builddate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AlloyTypeImpl extends MinimalEObjectImpl.Container implements AlloyType {
  ...
  public NotificationChain basicSetInstance(InstanceType newInstance, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.ALLOY_TYPE__INSTANCE, oldInstance, newInstance);
  ...
  public void setInstance(InstanceType newInstance) {
    if (newInstance != instance) {
      ...
      if (instance != null)
        msgs = ((InternalEObject)instance).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlloyXSDFilePackage.ALLOY_TYPE__INSTANCE, null, msgs);
      if (newInstance != null)
        msgs = ((InternalEObject)newInstance).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlloyXSDFilePackage.ALLOY_TYPE__INSTANCE, null, msgs);
      msgs = basicSetInstance(newInstance, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.ALLOY_TYPE__INSTANCE, newInstance, newInstance));
  }
  ...
  public void setBuilddate(String newBuilddate) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.ALLOY_TYPE__BUILDDATE, oldBuilddate, builddate));
  }
