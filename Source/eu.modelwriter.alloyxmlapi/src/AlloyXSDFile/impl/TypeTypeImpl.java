 ...
 * </p>
 * <ul>
 *   <li>{@link AlloyXSDFile.impl.TypeTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link AlloyXSDFile.impl.TypeTypeImpl#getID <em>ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeTypeImpl extends MinimalEObjectImpl.Container implements TypeType {
  ...
  public void setValue(String newValue) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.TYPE_TYPE__VALUE, oldValue, value));
  }
  ...
  public void setID(byte newID) {
    ...
    iDESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.TYPE_TYPE__ID, oldID, iD, !oldIDESet));
  }
  ...
  public void unsetID() {
    ...
    iDESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, AlloyXSDFilePackage.TYPE_TYPE__ID, oldID, ID_EDEFAULT, oldIDESet));
  }
