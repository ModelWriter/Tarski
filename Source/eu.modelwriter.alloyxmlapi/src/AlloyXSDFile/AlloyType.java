 ...
 * </p>
 * <ul>
 *   <li>{@link AlloyXSDFile.AlloyType#getInstance <em>Instance</em>}</li>
 *   <li>{@link AlloyXSDFile.AlloyType#getBuilddate <em>Builddate</em>}</li>
 * </ul>
 *
 * @see AlloyXSDFile.AlloyXSDFilePackage#getAlloyType()
...
public interface AlloyType extends EObject {
   ...
   * @see AlloyXSDFile.AlloyXSDFilePackage#getAlloyType_Instance()
  ...
  /**
   * Sets the value of the '{@link AlloyXSDFile.AlloyType#getInstance <em>Instance</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see AlloyXSDFile.AlloyXSDFilePackage#getAlloyType_Builddate()
  ...
  /**
   * Sets the value of the '{@link AlloyXSDFile.AlloyType#getBuilddate <em>Builddate</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
