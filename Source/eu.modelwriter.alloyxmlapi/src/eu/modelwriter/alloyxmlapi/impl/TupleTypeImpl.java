 ...
 * </p>
 * <ul>
 * <li>{@link eu.modelwriter.alloyxmlapi.impl.TupleTypeImpl#getAtom <em>Atom</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleTypeImpl extends MinimalEObjectImpl.Container implements TupleType {
  ...
  protected EClass eStaticClass() {
    return AlloyXSDFilePackage.Literals.TUPLE_TYPE;
  }
  ...
  public EList<AtomType> getAtom() {
    if (atom == null) {
      atom = new EObjectContainmentEList<AtomType>(AtomType.class, this,
          AlloyXSDFilePackage.TUPLE_TYPE__ATOM);
    }
    return atom;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID,
    ...
    switch (featureID) {
      case AlloyXSDFilePackage.TUPLE_TYPE__ATOM:
