...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Sig Type</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link eu.modelwriter.alloyxmlapi.impl.SigTypeImpl#getMixed <em>Mixed</em>}</li>
 * <li>{@link eu.modelwriter.alloyxmlapi.impl.SigTypeImpl#getAtom <em>Atom</em>}</li>
 * <li>{@link eu.modelwriter.alloyxmlapi.impl.SigTypeImpl#getAbstract <em>Abstract</em>}</li>
 * <li>{@link eu.modelwriter.alloyxmlapi.impl.SigTypeImpl#getBuiltin <em>Builtin</em>}</li>
 * <li>{@link eu.modelwriter.alloyxmlapi.impl.SigTypeImpl#getEnum <em>Enum</em>}</li>
 * <li>{@link eu.modelwriter.alloyxmlapi.impl.SigTypeImpl#getID <em>ID</em>}</li>
 * <li>{@link eu.modelwriter.alloyxmlapi.impl.SigTypeImpl#getLabel <em>Label</em>}</li>
 * <li>{@link eu.modelwriter.alloyxmlapi.impl.SigTypeImpl#getLocation <em>Location</em>}</li>
 * <li>{@link eu.modelwriter.alloyxmlapi.impl.SigTypeImpl#getLone <em>Lone</em>}</li>
 * <li>{@link eu.modelwriter.alloyxmlapi.impl.SigTypeImpl#getMeta <em>Meta</em>}</li>
 * <li>{@link eu.modelwriter.alloyxmlapi.impl.SigTypeImpl#getOne <em>One</em>}</li>
 * <li>{@link eu.modelwriter.alloyxmlapi.impl.SigTypeImpl#getParentID <em>Parent ID</em>}</li>
 * <li>{@link eu.modelwriter.alloyxmlapi.impl.SigTypeImpl#getPrivate <em>Private</em>}</li>
 * <li>{@link eu.modelwriter.alloyxmlapi.impl.SigTypeImpl#getSome <em>Some</em>}</li>
 * <li>{@link eu.modelwriter.alloyxmlapi.impl.SigTypeImpl#getSubset <em>Subset</em>}</li>
 * <li>{@link eu.modelwriter.alloyxmlapi.impl.SigTypeImpl#getSubsig <em>Subsig</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SigTypeImpl extends MinimalEObjectImpl.Container implements SigType {
  ...
  /**
   * The cached value of the '{@link #getBuiltin() <em>Builtin</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @see #getBuiltin()
   * @generated
  ...
  /**
   * The default value of the '{@link #getEnum() <em>Enum</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getEnum()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getEnum() <em>Enum</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getEnum()
   * @generated
  ...
  /**
   * The default value of the '{@link #getLone() <em>Lone</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getLone()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getLone() <em>Lone</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getLone()
   * @generated
  ...
  /**
   * The default value of the '{@link #getMeta() <em>Meta</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getMeta()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getMeta() <em>Meta</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getMeta()
   * @generated
  ...
  /**
   * The default value of the '{@link #getOne() <em>One</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getOne()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getOne() <em>One</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getOne()
   * @generated
  ...
  /**
   * This is true if the Parent ID attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc
   * -->
   * 
   * @generated
   * @ordered
  ...
  /**
   * The cached value of the '{@link #getPrivate() <em>Private</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @see #getPrivate()
   * @generated
  ...
  /**
   * The default value of the '{@link #getSome() <em>Some</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getSome()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getSome() <em>Some</em>}' attribute. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @see #getSome()
   * @generated
  ...
  /**
   * The default value of the '{@link #getSubset() <em>Subset</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @see #getSubset()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getSubset() <em>Subset</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @see #getSubset()
   * @generated
  ...
  /**
   * The default value of the '{@link #getSubsig() <em>Subsig</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @see #getSubsig()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getSubsig() <em>Subsig</em>}' attribute. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @see #getSubsig()
   * @generated
  ...
  public void setAbstract(String newAbstract) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.SIG_TYPE__ABSTRACT,
  ...
  public void setBuiltin(String newBuiltin) {
    ...
    builtin = newBuiltin;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.SIG_TYPE__BUILTIN,
          oldBuiltin, builtin));
  }
  ...
  public void setEnum(String newEnum) {
    ...
    enum_ = newEnum;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.SIG_TYPE__ENUM,
          oldEnum, enum_));
  }
  ...
  public void setID(byte newID) {
    ...
    iDESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.SIG_TYPE__ID, oldID,
          iD, !oldIDESet));
  }
  ...
  public void unsetID() {
    ...
    iDESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, AlloyXSDFilePackage.SIG_TYPE__ID,
  ...
  public void setLabel(String newLabel) {
    ...
    label = newLabel;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.SIG_TYPE__LABEL,
          oldLabel, label));
  }
  ...
  public void setLocation(Object newLocation) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.SIG_TYPE__LOCATION,
  ...
  public void setLone(String newLone) {
    ...
    lone = newLone;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.SIG_TYPE__LONE,
          oldLone, lone));
  }
  ...
  public void setMeta(String newMeta) {
    ...
    meta = newMeta;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.SIG_TYPE__META,
          oldMeta, meta));
  }
  ...
  public void setOne(String newOne) {
    ...
    one = newOne;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.SIG_TYPE__ONE,
          oldOne, one));
  }
  ...
  public void setParentID(byte newParentID) {
    ...
    parentIDESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.SIG_TYPE__PARENT_ID,
          oldParentID, parentID, !oldParentIDESet));
  }
  ...
  public void unsetParentID() {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.UNSET, AlloyXSDFilePackage.SIG_TYPE__PARENT_ID,
              oldParentID, PARENT_ID_EDEFAULT, oldParentIDESet));
  }
  ...
  public void setPrivate(String newPrivate) {
    ...
    private_ = newPrivate;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.SIG_TYPE__PRIVATE,
          oldPrivate, private_));
  }
  ...
  public void setSome(String newSome) {
    ...
    some = newSome;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.SIG_TYPE__SOME,
          oldSome, some));
  }
  ...
  public void setSubset(String newSubset) {
    ...
    subset = newSubset;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.SIG_TYPE__SUBSET,
          oldSubset, subset));
  }
  ...
  public void setSubsig(String newSubsig) {
    ...
    subsig = newSubsig;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlloyXSDFilePackage.SIG_TYPE__SUBSIG,
          oldSubsig, subsig));
  }
