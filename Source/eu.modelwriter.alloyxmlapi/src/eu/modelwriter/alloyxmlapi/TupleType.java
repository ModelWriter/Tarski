 ...
 * </p>
 * <ul>
 *   <li>{@link eu.modelwriter.alloyxmlapi.TupleType#getAtom <em>Atom</em>}</li>
 * </ul>
 *
 * @see eu.modelwriter.alloyxmlapi.AlloyXSDFilePackage#getTupleType()
...
public interface TupleType extends EObject {
   ...
   * @see eu.modelwriter.alloyxmlapi.AlloyXSDFilePackage#getTupleType_Atom()
