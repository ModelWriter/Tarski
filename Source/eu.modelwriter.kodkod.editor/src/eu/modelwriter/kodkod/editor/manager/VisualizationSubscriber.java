...
public class VisualizationSubscriber implements Notifier {
  ...
  public void addTupleNotify(final String arg0, final String arg1, final List<String> arg2,
      final String arg3) {
    this.run(arg0, arg1, arg2, arg3, NOTIFY_MODE.ADD_TUPLE);
  }
  ...
  public void moveToLower(final String arg0, final String arg1, final List<String> arg2) {
    this.run(arg0, arg1, arg2, NOTIFY_MODE.MOVE_TO_LOWER);
  }
  ...
  public void moveToUpper(final String arg0, final String arg1, final List<String> arg2) {
    this.run(arg0, arg1, arg2, NOTIFY_MODE.MOVE_TO_UPPER);
  }
  ...
  public void removeTupleNotify(final String arg0, final String arg1, final List<String> arg2,
      final String arg3) {
    this.run(arg0, arg1, arg2, arg3, NOTIFY_MODE.REMOVE_TUPLE);
  }

  private void run(final String relationName, final List<String> tuple, final NOTIFY_MODE MODE) {
    this.run(relationName, null, tuple, null, MODE);
  }

  private void run(final String relationName, final List<String> tuple, final String bound,
      final NOTIFY_MODE MODE) {
    this.run(relationName, null, tuple, bound, MODE);
  }

  private void run(final String relationName, final String inRelationName, final List<String> tuple,
      final NOTIFY_MODE MODE) {
    this.run(relationName, inRelationName, tuple, null, MODE);
  }

  private void run(final String relationName, final String inRelationName, final List<String> tuple,
      final String bound, final NOTIFY_MODE MODE) {
