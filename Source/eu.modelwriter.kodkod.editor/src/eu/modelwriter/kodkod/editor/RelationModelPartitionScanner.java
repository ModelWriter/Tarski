...
public class RelationModelPartitionScanner extends RuleBasedPartitionScanner {
	...
	public final static String[] PARTITION_TYPES = new String[] { IDocument.DEFAULT_CONTENT_TYPE,
			RelationModelPartitionScanner.RELATION_MODEL_COMMENT, RelationModelPartitionScanner.RELATION_MODEL_OPTION,
	...
	public RelationModelPartitionScanner() {
		...
		final IToken universePartition = new Token(RelationModelPartitionScanner.RELATION_MODEL_UNIVERSE);
		final IToken relBoundPartition = new Token(RelationModelPartitionScanner.RELATION_MODEL_REL_BOUND);
		...
		rules.add(new MultiLineRule("universe [", "]", universePartition));
		rules.add(new RelationBoundsRule("Relations:", "Formulas:", relBoundPartition, (char) 0, false));
		// rules.add(new MultiLineRule("Relations:", "Formulas:",
		// relBoundPartition));
