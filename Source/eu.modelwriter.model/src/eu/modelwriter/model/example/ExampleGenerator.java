...
public class ExampleGenerator {
  ...
  public static ModelManager createFileSystemExample() {
    ...
    manager.addAtom(Arrays.asList(new String[] {"List", "EmptyList"}), null,
        Tuple.BOUND.LOWER_BOUND);

    /** Atoms **/
    final Atom Root$0 =
        manager.addAtom(Arrays.asList(new String[] {"Root"}), null, Tuple.BOUND.LOWER_BOUND);

    final Atom Directory$0 =
        manager.addAtom(Arrays.asList(new String[] {"Directory"}), null, Tuple.BOUND.LOWER_BOUND);
    final Atom Directory$1 =
        manager.addAtom(Arrays.asList(new String[] {"Directory"}), null, Tuple.BOUND.LOWER_BOUND);

    final Atom Alias$0 =
        manager.addAtom(Arrays.asList(new String[] {"Alias"}), null, Tuple.BOUND.LOWER_BOUND);
    final Atom Alias$1 =
        manager.addAtom(Arrays.asList(new String[] {"Alias"}), null, Tuple.BOUND.LOWER_BOUND);
    final Atom Alias$2 =
        manager.addAtom(Arrays.asList(new String[] {"Alias"}), null, Tuple.BOUND.LOWER_BOUND);
    ...
    final Atom Word$0 =
        manager.addAtom(Arrays.asList(new String[] {"Word"}), null, Tuple.BOUND.LOWER_BOUND);
    final Atom Word$1 =
        manager.addAtom(Arrays.asList(new String[] {"Word"}), null, Tuple.BOUND.LOWER_BOUND);
    final Atom Word$2 =
        manager.addAtom(Arrays.asList(new String[] {"Word"}), null, Tuple.BOUND.LOWER_BOUND);
  ...
  public static ModelManager createInExample() {
    ...
    final Atom Ferhat$0 =
        manager.addAtom(Arrays.asList(new String[] {"Ferhat"}), null, Tuple.BOUND.LOWER_BOUND);
    final Atom Ferhat$1 =
        manager.addAtom(Arrays.asList(new String[] {"Ferhat"}), null, Tuple.BOUND.LOWER_BOUND);
    final Atom Ferhat$2 =
        manager.addAtom(Arrays.asList(new String[] {"Ferhat"}), null, Tuple.BOUND.LOWER_BOUND);
    ...
    final Atom Anil$0 =
        manager.addAtom(Arrays.asList(new String[] {"Anil"}), null, Tuple.BOUND.LOWER_BOUND);

    manager.addAtom(Arrays.asList(new String[] {"Serhat"}), null, Tuple.BOUND.LOWER_BOUND);
    manager.addAtom(Arrays.asList(new String[] {"Serhat"}), null, Tuple.BOUND.LOWER_BOUND);
    manager.addAtom(Arrays.asList(new String[] {"Serhat"}), null, Tuple.BOUND.LOWER_BOUND);
    manager.addAtom(Arrays.asList(new String[] {"Serhat"}), null, Tuple.BOUND.LOWER_BOUND);
    final Atom Serhat$4 =
