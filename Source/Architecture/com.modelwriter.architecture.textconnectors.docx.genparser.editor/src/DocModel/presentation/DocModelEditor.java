 ...
 * @generated
 */
public class DocModelEditor extends MultiPageEditorPart
  ...
  public static final List<String> FILE_EXTENSION_FILTERS =
      prefixExtensions(DocModelModelWizard.FILE_EXTENSIONS, "*.");

  /**
   * Returns a new unmodifiable list containing prefixed versions of the extensions in the given
  ...
  protected void updateProblemIndication() {
    if (updateProblemIndication) {
      BasicDiagnostic diagnostic = new BasicDiagnostic(Diagnostic.OK,
          "com.modelwriter.architecture.textconnectors.docx.genparser.editor", 0, null,
  ...
  public Diagnostic analyzeResourceProblems(Resource resource, Exception exception) {
    if (!resource.getErrors().isEmpty() || !resource.getWarnings().isEmpty()) {
      BasicDiagnostic basicDiagnostic = new BasicDiagnostic(Diagnostic.ERROR,
          "com.modelwriter.architecture.textconnectors.docx.genparser.editor", 0,
  ...
  public void createPages() {
    ...
    if (!getEditingDomain().getResourceSet().getResources().isEmpty()) {
      ...
      //
      {
        ViewerPane viewerPane = new ViewerPane(getSite().getPage(), DocModelEditor.this) {
          @Override
  ...
  public void doSaveAs() {
    ...
    String[] files =
        DocumentModelEditorAdvisor.openFilePathDialog(getSite().getShell(), SWT.SAVE, filters);
    if (files.length > 0) {
