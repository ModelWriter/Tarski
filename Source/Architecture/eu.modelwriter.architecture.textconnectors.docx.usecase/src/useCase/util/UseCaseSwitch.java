  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID) {
      ...
      case UseCasePackage.SPECIFICATION: {
        ...
        if (result == null)
          result = caseNamedElement(specification);
        if (result == null)
          result = caseElement(specification);
        if (result == null)
          result = defaultCase(theEObject);
        return result;
      }
      ...
      case UseCasePackage.CONDITIONAL_FLOW: {
        ...
        if (result == null)
          result = caseFlow(conditionalFlow);
        if (result == null)
          result = caseFlowElement(conditionalFlow);
        if (result == null)
          result = caseElement(conditionalFlow);
        if (result == null)
          result = defaultCase(theEObject);
        return result;
      }
      ...
      case UseCasePackage.DOCUMENTATION: {
        ...
        if (result == null)
          result = caseElement(documentation);
        if (result == null)
          result = defaultCase(theEObject);
        return result;
      }
      ...
      case UseCasePackage.INTERMEDIATE_CATCH_EVENT: {
        ...
        if (result == null)
          result = caseElement(IntermediateCatchEvent);
        if (result == null)
          result = defaultCase(theEObject);
        return result;
      }
      case UseCasePackage.INTERMEDIATE_THROW_EVENT: {
        ...
        if (result == null)
          result = caseElement(IntermediateThrowEvent);
        if (result == null)
          result = defaultCase(theEObject);
        return result;
      }
      ...
      case UseCasePackage.PARALLEL_GATEWAY: {
        ...
        if (result == null)
          result = caseElement(parallelGateway);
        if (result == null)
          result = defaultCase(theEObject);
        return result;
      }
