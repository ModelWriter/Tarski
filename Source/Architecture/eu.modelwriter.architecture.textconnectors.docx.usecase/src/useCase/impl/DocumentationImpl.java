...
public class DocumentationImpl extends ElementImpl implements Documentation {
  ...
  public void setText(String newText) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UseCasePackage.DOCUMENTATION__TEXT,
          oldText, text));
  }
  ...
  public void setTextFormat(String newTextFormat) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          UseCasePackage.DOCUMENTATION__TEXT_FORMAT, oldTextFormat, textFormat));
  }
