...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Use Case</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link useCase.impl.UseCaseImpl#getPrimaryActor <em>Primary Actor</em>}</li>
 * <li>{@link useCase.impl.UseCaseImpl#getOwnedStakeholderInterest
 * <em>Owned Stakeholder Interest</em>}</li>
...
public class UseCaseImpl extends NamedElementImpl implements UseCase {
  ...
  /**
   * The cached value of the '{@link #getOwnedStakeholderInterest()
   * <em>Owned Stakeholder Interest</em>}' containment reference list. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getOwnedMainFlow() <em>Owned Main Flow</em>}' containment
  ...
  /**
   * The cached value of the '{@link #getOwnedAlternativeFlow() <em>Owned Alternative Flow</em>}'
  ...
  public EList<Actor> getPrimaryActor() {
    if (primaryActor == null) {
      primaryActor = new EObjectResolvingEList<Actor>(Actor.class, this,
          UseCasePackage.USE_CASE__PRIMARY_ACTOR);
    }
    return primaryActor;
  }
  ...
  public EList<Interest> getOwnedStakeholderInterest() {
    if (ownedStakeholderInterest == null) {
      ownedStakeholderInterest = new EObjectContainmentEList<Interest>(Interest.class, this,
          UseCasePackage.USE_CASE__OWNED_STAKEHOLDER_INTEREST);
    }
   ...
   * @generated
   */
  public NotificationChain basicSetOwnedMainFlow(useCase.Process newOwnedMainFlow,
      NotificationChain msgs) {
    useCase.Process oldOwnedMainFlow = ownedMainFlow;
    ownedMainFlow = newOwnedMainFlow;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UseCasePackage.USE_CASE__OWNED_MAIN_FLOW, oldOwnedMainFlow, newOwnedMainFlow);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setOwnedMainFlow(useCase.Process newOwnedMainFlow) {
    if (newOwnedMainFlow != ownedMainFlow) {
      ...
      if (ownedMainFlow != null)
        msgs = ((InternalEObject) ownedMainFlow).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UseCasePackage.USE_CASE__OWNED_MAIN_FLOW, null, msgs);
      if (newOwnedMainFlow != null)
        msgs = ((InternalEObject) newOwnedMainFlow).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - UseCasePackage.USE_CASE__OWNED_MAIN_FLOW, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          UseCasePackage.USE_CASE__OWNED_MAIN_FLOW, newOwnedMainFlow, newOwnedMainFlow));
  }
  ...
  public EList<useCase.Process> getOwnedAlternativeFlow() {
    if (ownedAlternativeFlow == null) {
      ownedAlternativeFlow = new EObjectContainmentEList<useCase.Process>(useCase.Process.class,
          this, UseCasePackage.USE_CASE__OWNED_ALTERNATIVE_FLOW);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID,
    ...
    switch (featureID) {
      ...
      case UseCasePackage.USE_CASE__OWNED_MAIN_FLOW:
        return basicSetOwnedMainFlow(null, msgs);
      case UseCasePackage.USE_CASE__OWNED_ALTERNATIVE_FLOW:
