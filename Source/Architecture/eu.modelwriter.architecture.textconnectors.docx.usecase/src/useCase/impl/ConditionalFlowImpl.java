...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Conditional Flow</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link useCase.impl.ConditionalFlowImpl#getConditionExpression <em>Condition Expression</em>}
 * </li>
 * </ul>
 * </p>
 *
      ...
      if (conditionExpression != oldConditionExpression) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              UseCasePackage.CONDITIONAL_FLOW__CONDITION_EXPRESSION, oldConditionExpression,
              conditionExpression));
      }
    }
