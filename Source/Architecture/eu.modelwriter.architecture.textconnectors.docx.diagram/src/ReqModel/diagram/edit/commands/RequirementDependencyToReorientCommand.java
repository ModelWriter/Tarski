 ...
 * @generated
 */
public class RequirementDependencyToReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RequirementDependencyToReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ReqModel.diagram.edit.policies.ReqModelBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistRequirementDependencyTo_4002(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setDependencyTo(null);
		getNewSource().setDependencyTo(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setDependencyTo(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
