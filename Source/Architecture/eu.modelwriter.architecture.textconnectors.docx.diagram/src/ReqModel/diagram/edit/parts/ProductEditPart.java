...
public class ProductEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "ReqModel"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ReqModel.diagram.edit.policies.ProductItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ReqModel.diagram.edit.policies.ProductCanonicalEditPolicy());
		installEditPolicy(
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new ReqModel.diagram.edit.commands.ReqModelCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
