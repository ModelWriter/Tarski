 ...
 * @generated
 */
public class ReqModelDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public ReqModelDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof ReqModel.diagram.navigator.ReqModelDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((ReqModel.diagram.navigator.ReqModelDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new ReqModel.diagram.navigator.ReqModelDomainNavigatorItem(
