...
public class ModelComparator {
  ...
  public static void main(String[] args) {
    ...
    /*
     * ICompareEditingDomain editingDomain = EMFCompareEditingDomain.create(resourceSet1,
     * resourceSet2, null); ComposedAdapterFactory adapterFactory = new
     * ComposedAdapterFactory(ComposedAdapterFactory.Descriptor.Registry.INSTANCE);
     * CompareEditorInput input = new ComparisonEditorInput((EMFCompareConfiguration) new
     * CompareConfiguration(), comparison, editingDomain, adapterFactory);
     * 
