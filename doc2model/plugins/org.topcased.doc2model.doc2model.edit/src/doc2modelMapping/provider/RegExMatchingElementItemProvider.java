 ...
 * </copyright>
 *
 * $Id: RegExMatchingElementItemProvider.java,v 1.1 2009/05/11 06:38:54 tfaure Exp $
 */
...
/**
 * This is the item provider adapter for a {@link doc2modelMapping.RegExMatchingElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegExMatchingElementItemProvider
        ...
        IItemPropertySource
{
     ...
     * @generated
     */
    public RegExMatchingElementItemProvider(AdapterFactory adapterFactory)
    {
    ...
    {
        String label = ((RegExMatchingElement)object).getRegExToMatch();
        return label == null || label.length() == 0 ?
            getString("_UI_RegExMatchingElement_type") :
            getString("_UI_RegExMatchingElement_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification)
    {
        ...
        switch (notification.getFeatureID(RegExMatchingElement.class))
        {
