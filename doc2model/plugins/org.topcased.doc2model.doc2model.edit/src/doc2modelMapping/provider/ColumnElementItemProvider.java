 ...
 * </copyright>
 *
 * $Id: ColumnElementItemProvider.java,v 1.1 2009/05/11 06:38:54 tfaure Exp $
 */
...
/**
 * This is the item provider adapter for a {@link doc2modelMapping.ColumnElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ColumnElementItemProvider
    extends RegExMatchingElementItemProvider
    implements
        ...
        IItemPropertySource
{
     ...
     * @generated
     */
    public ColumnElementItemProvider(AdapterFactory adapterFactory)
    {
    ...
    {
        String label = ((ColumnElement)object).getRegExToMatch();
        return label == null || label.length() == 0 ?
            getString("_UI_ColumnElement_type") :
            getString("_UI_ColumnElement_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification)
    {
        ...
        switch (notification.getFeatureID(ColumnElement.class))
        {
