...
/**
 * The Class DocumentNameResolver.
 * get the name of the document
 */
public class DocumentNameResolver implements VariableResolver
{

    public DocumentNameResolver()
    {
    }

    public String getValue(ParsingProcess parser)
    {
        return parser.getDocument().getDocumentFile().getName();
    }
