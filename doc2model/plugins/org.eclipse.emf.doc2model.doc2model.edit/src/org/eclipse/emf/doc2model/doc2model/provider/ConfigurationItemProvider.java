...
public class ConfigurationItemProvider extends ItemProviderAdapter implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Configuration_extension_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_extension_feature", "_UI_Configuration_type"),
				 Doc2modelPackage.Literals.CONFIGURATION__EXTENSION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Doc2modelPackage.Literals.CONFIGURATION__INITIAL_MODEL);
			childrenFeatures.add(Doc2modelPackage.Literals.CONFIGURATION__EPACKAGES);
		}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add
			(createChildParameter
				(Doc2modelPackage.Literals.CONFIGURATION__INITIAL_MODEL,
				 Doc2modelFactory.eINSTANCE.createInitialModel()));

		newChildDescriptors.add
			(createChildParameter
				(Doc2modelPackage.Literals.CONFIGURATION__EPACKAGES,
				 Doc2modelFactory.eINSTANCE.createEPackageReference()));
	}
