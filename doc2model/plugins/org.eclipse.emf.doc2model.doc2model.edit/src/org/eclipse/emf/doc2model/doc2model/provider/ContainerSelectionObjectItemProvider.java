...
public class ContainerSelectionObjectItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Doc2modelPackage.Literals.CONTAINER_SELECTION_OBJECT__SELECTION);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ContainerSelectionObject_type") :
			getString("_UI_ContainerSelectionObject_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ContainerSelectionObject.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Doc2modelPackage.Literals.CONTAINER_SELECTION_OBJECT__SELECTION,
				 Doc2modelFactory.eINSTANCE.createCurrentContainerSelection()));

		newChildDescriptors.add
			(createChildParameter
				(Doc2modelPackage.Literals.CONTAINER_SELECTION_OBJECT__SELECTION,
				 Doc2modelFactory.eINSTANCE.createLastElementCreatedSelection()));

		newChildDescriptors.add
			(createChildParameter
				(Doc2modelPackage.Literals.CONTAINER_SELECTION_OBJECT__SELECTION,
				 Doc2modelFactory.eINSTANCE.createStaticElementSelection()));

		newChildDescriptors.add
			(createChildParameter
				(Doc2modelPackage.Literals.CONTAINER_SELECTION_OBJECT__SELECTION,
				 Doc2modelFactory.eINSTANCE.createLastContainerConsideringMatchOrder()));
	}
