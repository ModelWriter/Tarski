		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rule_match_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rule_match_feature", "_UI_Rule_type"),
				 Doc2modelPackage.Literals.RULE__MATCH,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Doc2modelPackage.Literals.RULE__ACTIONS,
				 true,
				 false,
				 true,
				 null,
